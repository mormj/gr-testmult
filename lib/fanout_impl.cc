...
fanout::sptr fanout::make() { return gnuradio::make_block_sptr<fanout_impl>(); }
...
void fanout_impl::forecast(int noutput_items, gr_vector_int& ninput_items_required)
{
    ninput_items_required[0] = noutput_items;
}

int fanout_impl::general_work(int noutput_items,
